...
local BULLET_GRAVITY = Vector3.new(0, -0.1, 0)		-- The amount of gravity applied to the bullet in world space (so yes, you can have sideways gravity)
...
local function RefSimulateBeforePhysicslect(surfaceNormal, bulletNormal)
